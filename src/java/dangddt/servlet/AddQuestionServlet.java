...
public class AddQuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String question_content = request.getParameter("question_content").trim();
            ...
            if (question_content.trim().length() > 0 && answerID_content.length != 0) {
                answers = new Vector();
                ...
                if (answers != null) {
                    String new_questionID = QuestionDAO.insert(question_content, subjectID, answers);
                    if (new_questionID != null) {
                        url = page_constant.get(current_page);
                        request.setAttribute("MESSAGE", "Add question '" + new_questionID + "' successfully");
                        request.setAttribute("NEW_QUESTION", new_questionID);
                    }
                }
            }
