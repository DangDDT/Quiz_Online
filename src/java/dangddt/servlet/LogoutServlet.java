...
public class LogoutServlet extends HttpServlet {
    ...
    private static final String LOGOUT_SUCCESS = "login_page";
    private static final String LOGOUT_FAILED = "error";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = page_constant.get(LOGOUT_FAILED);
        try {
            ...
            if (cookies.length > 0) {
                ...
                url = page_constant.get(LOGOUT_SUCCESS);
